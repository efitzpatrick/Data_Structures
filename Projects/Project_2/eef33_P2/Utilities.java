...
public class Utilities {
    ...
    public static int encodeDocument(String input, String output, Hashtable<Character, String> encodings, Hashtable<Character, Integer> frequency) throws IOException {
